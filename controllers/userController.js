...
// changepassword
export const changePassword = catchAsycError(async(req, res, next)=>{
...
export const forgetPassword = catchAsycError(async(req, res, next)=>{
  ...
  // http://localhost:3000/resetpassword/eritpeueopyuouy8
...
export const UpdateUserRoll = catchAsycError(async(req, res, next) => {
