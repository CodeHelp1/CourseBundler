...
export const getAllCourses = catchAsycError (async (req , res, next) => {
...
export const getCourseLectures = catchAsycError (async (req , res, next) => {
...
export const addLecture = catchAsycError (async (req , res, next) => {
    const {id} = req.params;
