...
export const buySubscription = catchAsycError(async (req, res, next) => {
   ...
   const plan_id = process.env.PLAN_ID || "plan_L4hxrXM303khOD";
...
export const cancelSubscription = catchAsycError(async(req, res, next) => {
    ...
    res.status(200).json({
        success: true,
        message:
        refund ? "Subscription cancelled, You will receive full refund within 7 days." : "Subscription cancelled, Now refund initiated as subscription was cancelled after 7 days",
    });
});