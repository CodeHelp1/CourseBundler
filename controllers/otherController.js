...
export const contact = catchAsycError(async (req, res, next) => {
...
export const courseRequest = catchAsycError(async (req, res, next) => {
...
export const getDashboardStats = catchAsycError(async (req, res, next) => {
